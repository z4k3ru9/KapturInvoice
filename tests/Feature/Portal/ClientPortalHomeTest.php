...
class ClientPortalHomeTest extends TestCase
{
    ...
    /**
     * Ported from the pre-TallStackUI legacy admin admin's Client Contacts
     * relation manager's "Generate portal link" row action during the
     * legacy admin-removal Phase B — the same
    ...
    /**
     * Ported from the pre-TallStackUI legacy admin admin's Portal Links
