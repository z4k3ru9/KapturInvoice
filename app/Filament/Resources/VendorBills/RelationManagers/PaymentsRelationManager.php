                ...
                Action::make('verify')
                    ...
                    ->action(function (VendorPayment $record, array $data) {
                        try {
                            ...
                            Notification::make()->success()->seconds(4)->title('Vendor payment verified')->send();
                        } catch (RuntimeException $e) {
                            Notification::make()->danger()->persistent()->title('Could not verify vendor payment')->body($e->getMessage())->send();
                        }
                    }),
                Action::make('issueReceipt')
                    ...
                    ->action(function (VendorPayment $record) {
                        try {
                            ...
                            Notification::make()->success()->seconds(4)->title('Vendor payment receipt issued')->send();
                        } catch (RuntimeException $e) {
                ...
                Action::make('amend')
                    ...
                    ->action(function (VendorPayment $record, array $data) {
                        try {
                            ...
                            Notification::make()->success()->seconds(4)->title('Vendor payment amended')->send();
                        } catch (RuntimeException $e) {
                            Notification::make()->danger()->persistent()->title('Could not amend vendor payment')->body($e->getMessage())->send();
                        }
                    }),
                Action::make('reverse')
                    ->label('Reverse')
                    ...
                    ->action(function (VendorPayment $record, array $data) {
                        try {
                            ...
                            Notification::make()->success()->seconds(4)->title('Vendor payment reversed')->send();
                        } catch (RuntimeException $e) {
                            Notification::make()->danger()->persistent()->title('Could not reverse vendor payment')->body($e->getMessage())->send();
                        }
                    }),
            ]);
    }
