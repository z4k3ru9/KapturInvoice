                ...
                Action::make('allocateToJob')
                    ...
                    ->action(function (VendorBillItem $record, array $data) {
                        try {
                            ...
                            Notification::make()->success()->seconds(4)->title('Cost allocated to job')->send();
                        } catch (RuntimeException $e) {
                            Notification::make()->danger()->persistent()->title('Could not allocate cost')->body($e->getMessage())->send();
                        }
                    }),
            ])
            ->toolbarActions([
