                ...
                Action::make('recordVariation')
                    ...
                    ->action(function (array $data) {
                        ...
                        try {
                            ...
                            Notification::make()->success()->seconds(4)->title('Variation approved')->send();
                        } catch (RuntimeException $e) {
                            Notification::make()->danger()->persistent()->title('Could not approve variation')->body($e->getMessage())->send();
                        }
                    }),
            ]);
    }
