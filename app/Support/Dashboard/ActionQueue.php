 ...
 * §3 for the approved per-role queue contents. Implementation constraint:
 * every link goes to a plain TALL-stack register/index page (no
 * `?tableFilters=` deep link — that needs status-filter wiring this slice
